...
@Component({
  selector: 'app-view-about-curriculum',
  templateUrl: './view-about-curriculum.component.html',
  styleUrls: ['./view-about-curriculum.component.css']
})
export class ViewAboutCurriculumComponent implements OnInit {

  constructor(private route: ActivatedRoute, private articleServise: ArticleServiceService, private router: Router) { }
  ...
  readUsers(id: string): void {
    this.articleServise.getAllArticlesByCurriculumId(id).subscribe(
      article => {
        this.myFunc(article);
      },
      error => {
